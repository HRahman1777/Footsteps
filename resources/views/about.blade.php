        ...
        <div class="text-secondary px-4 py-5 text-center shadow" style="background: #65b1fdf2">
            <div class="py-5">
                ...
                <div class="col-lg-6 mx-auto">
                    <p class="fs-5 mb-4">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ducimus quam aperiam corrupti enim
                        adipisci molestias cupiditate, autem repellendus explicabo earum culpa nobis consectetur aliquid
                        eveniet tenetur quasi, sint neque voluptatum.
                    </p>
